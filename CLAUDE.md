...
- A collaborator edits `data/products.json` from the GitHub web editor. Keep
  that file one product per line, and keep the README a step-by-step guide in
  Spanish. Fetch before pushing: their commits arrive unannounced.
